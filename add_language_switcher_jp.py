...
<div class="language-switcher-container">
  <div class="language-switcher">
    <a class="language-switcher-not-active" href="index.html">EN</a>
    <a class="language-switcher-active" href="index_jp.html">JP</a>
  </div>
</div>
<!-- END LANGUAGE -->
"""
...
html_files = glob.glob(os.path.join(directory_path, '*_jp.html'))
